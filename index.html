    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Windows-Firewall : </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Technical Support:<span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-844-922-0134 </span> </span>
            </div>
        </div>
        <div class="col-md-12">
...
<div id="poptxt" class="lightbox" style="display: block;">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Technical Support: +1-844-922-0134  </span>
    </div>
    <div id="bottom">
